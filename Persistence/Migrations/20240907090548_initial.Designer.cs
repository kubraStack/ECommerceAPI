...
namespace Persistence.Migrations
{
    ...
    [Migration("20240907090548_initial")]
            ...
            modelBuilder.Entity("Domain.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 9, 7, 12, 5, 47, 805, DateTimeKind.Local).AddTicks(3001),
                            Name = "AdminRole"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 9, 7, 12, 5, 47, 805, DateTimeKind.Local).AddTicks(3007),
                            Name = "CustomerRole"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 9, 7, 12, 5, 47, 805, DateTimeKind.Local).AddTicks(3010),
                            Name = "GuestRole"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 500m,
                            OrderId = 1,
                            PaymentDate = new DateTime(2024, 9, 7, 12, 5, 47, 805, DateTimeKind.Local).AddTicks(2689),
                            PaymentMethodId = 1
                        },
                        new
                        {
                            ...
                            Amount = 200m,
                            OrderId = 2,
                            PaymentDate = new DateTime(2024, 9, 7, 12, 5, 47, 805, DateTimeKind.Local).AddTicks(2711),
                            PaymentMethodId = 2
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 9, 7, 9, 5, 47, 805, DateTimeKind.Utc).AddTicks(1619),
                            Email = "customer1@example.com",
                            FirstName = "+2vS9SiEjuEtdomA+E1iOw==",
                            Gender = "Famela",
                            IsDeleted = false,
                            LastName = "evKlCl7mIBJkEqQf5ueGMg==",
                            PasswordHash = new byte[] { 18, 226, 70, 159, 81, 139, 212, 48, 213, 207, 187, 103, 38, 162, 116, 245, 177, 103, 13, 143, 47, 37, 77, 251, 189, 87, 24, 31, 127, 66, 164, 108, 101, 162, 63, 2, 0, 219, 94, 184, 59, 146, 144, 35, 134, 144, 109, 209, 22, 241, 248, 39, 106, 37, 91, 61, 51, 55, 146, 220, 74, 194, 176, 73 },
                            PasswordSalt = new byte[] { 36, 190, 100, 9, 165, 91, 183, 14, 78, 126, 115, 217, 117, 243, 192, 174, 149, 30, 11, 51, 190, 34, 168, 141, 9, 105, 125, 30, 115, 25, 237, 161, 176, 80, 226, 61, 101, 215, 207, 33, 210, 133, 70, 206, 80, 252, 73, 108, 206, 109, 161, 230, 40, 168, 130, 47, 150, 108, 23, 36, 87, 252, 200, 251, 65, 144, 117, 14, 49, 210, 195, 47, 155, 125, 167, 150, 0, 69, 203, 151, 158, 164, 218, 143, 85, 59, 154, 115, 80, 121, 74, 172, 252, 158, 138, 72, 15, 12, 146, 37, 171, 99, 123, 60, 47, 68, 146, 202, 93, 100, 172, 179, 86, 50, 224, 225, 199, 186, 36, 47, 165, 138, 23, 142, 154, 121, 139, 253 },
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 9, 7, 9, 5, 47, 805, DateTimeKind.Utc).AddTicks(1719),
                        ...
                        {
                            Id = 99,
                            CreatedDate = new DateTime(2024, 9, 7, 9, 5, 47, 805, DateTimeKind.Utc).AddTicks(1826),
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 9, 7, 12, 5, 47, 805, DateTimeKind.Local).AddTicks(3103),
                            OperationClaimId = 1,
                            UserId = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 9, 7, 12, 5, 47, 805, DateTimeKind.Local).AddTicks(3109),
                            OperationClaimId = 2,
                            UserId = 2
                        });
                });
