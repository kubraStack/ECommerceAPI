            ...
            modelBuilder.Entity("Domain.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 10, 11, 3, 51, 13, 242, DateTimeKind.Local).AddTicks(2651),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 10, 11, 3, 51, 13, 242, DateTimeKind.Local).AddTicks(2658),
                            Name = "Customer"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 10, 11, 3, 51, 13, 242, DateTimeKind.Local).AddTicks(2663),
                            Name = "Guest"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 500m,
                            OrderId = 1,
                            PaymentDate = new DateTime(2024, 10, 11, 3, 51, 13, 242, DateTimeKind.Local).AddTicks(2187),
                            PaymentMethodId = 1
                        },
                        new
                        {
                            ...
                            Amount = 200m,
                            OrderId = 2,
                            PaymentDate = new DateTime(2024, 10, 11, 3, 51, 13, 242, DateTimeKind.Local).AddTicks(2208),
                            PaymentMethodId = 2
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 10, 11, 0, 51, 13, 242, DateTimeKind.Utc).AddTicks(1081),
                            Email = "customer1@example.com",
                            FirstName = "+2vS9SiEjuEtdomA+E1iOw==",
                            Gender = "Famela",
                            IsDeleted = false,
                            LastName = "evKlCl7mIBJkEqQf5ueGMg==",
                            PasswordHash = new byte[] { 59, 129, 232, 225, 35, 81, 160, 28, 76, 230, 121, 41, 250, 53, 81, 9, 253, 198, 160, 58, 117, 77, 130, 40, 101, 178, 89, 26, 3, 253, 180, 9, 244, 202, 40, 233, 54, 222, 146, 42, 82, 121, 168, 203, 93, 177, 18, 121, 171, 114, 116, 162, 190, 173, 110, 56, 187, 138, 155, 228, 185, 34, 72, 104 },
                            PasswordSalt = new byte[] { 93, 49, 245, 65, 125, 245, 118, 220, 21, 57, 48, 116, 228, 17, 237, 255, 17, 109, 140, 1, 160, 46, 41, 64, 168, 187, 223, 243, 232, 238, 120, 145, 173, 175, 105, 37, 236, 233, 161, 7, 17, 251, 173, 118, 200, 246, 93, 25, 45, 25, 135, 57, 162, 216, 125, 117, 135, 91, 223, 66, 110, 64, 84, 9, 255, 228, 214, 219, 26, 41, 138, 199, 8, 98, 116, 124, 254, 200, 20, 38, 196, 180, 196, 36, 202, 140, 244, 102, 127, 1, 2, 133, 27, 231, 88, 106, 34, 43, 239, 58, 250, 113, 145, 162, 81, 143, 107, 215, 9, 129, 157, 220, 247, 3, 228, 83, 170, 125, 127, 157, 18, 182, 73, 219, 54, 150, 14, 15 },
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 10, 11, 0, 51, 13, 242, DateTimeKind.Utc).AddTicks(1211),
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 10, 11, 0, 51, 13, 242, DateTimeKind.Utc).AddTicks(1342),
                        ...
                        {
                            Id = 99,
                            CreatedDate = new DateTime(2024, 10, 11, 0, 51, 13, 242, DateTimeKind.Utc).AddTicks(1452),
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 10, 11, 3, 51, 13, 242, DateTimeKind.Local).AddTicks(2766),
                            OperationClaimId = 1,
                            UserId = 99
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 10, 11, 3, 51, 13, 242, DateTimeKind.Local).AddTicks(2775),
                            OperationClaimId = 2,
                            UserId = 1
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 10, 11, 3, 51, 13, 242, DateTimeKind.Local).AddTicks(2779),
                            OperationClaimId = 3,
                            UserId = 3
                        },
                        new
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2024, 10, 11, 3, 51, 13, 242, DateTimeKind.Local).AddTicks(2783),
                            OperationClaimId = 3,
                            UserId = 2
                        });
                });
