...
namespace Persistence.Migrations
{
    ...
    [Migration("20241121233930_initial")]
            ...
            modelBuilder.Entity("Domain.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 11, 22, 2, 39, 29, 643, DateTimeKind.Local).AddTicks(5980),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 11, 22, 2, 39, 29, 643, DateTimeKind.Local).AddTicks(5987),
                            Name = "Customer"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 11, 22, 2, 39, 29, 643, DateTimeKind.Local).AddTicks(5991),
                            Name = "Guest"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 500m,
                            OrderId = 1,
                            PaymentDate = new DateTime(2024, 11, 22, 2, 39, 29, 643, DateTimeKind.Local).AddTicks(5271),
                            PaymentMethodId = 1,
                            PaymentStatus = 0
                        },
                        new
                        {
                            ...
                            Amount = 200m,
                            OrderId = 2,
                            PaymentDate = new DateTime(2024, 11, 22, 2, 39, 29, 643, DateTimeKind.Local).AddTicks(5289),
                            PaymentMethodId = 2,
                            PaymentStatus = 0
                        },
                        new
                        {
                            ...
                            Amount = 100.00m,
                            OrderId = 1,
                            PaymentDate = new DateTime(2024, 11, 21, 23, 39, 29, 643, DateTimeKind.Utc).AddTicks(6225),
                            PaymentMethodId = 1,
                            PaymentStatus = 1
                        },
                        new
                        {
                            ...
                            Amount = 200.00m,
                            OrderId = 2,
                            PaymentDate = new DateTime(2024, 11, 21, 23, 39, 29, 643, DateTimeKind.Utc).AddTicks(6253),
                            PaymentMethodId = 2,
                            PaymentStatus = 2
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 11, 21, 23, 39, 29, 643, DateTimeKind.Utc).AddTicks(4256),
                            Email = "customer1@example.com",
                            FirstName = "+2vS9SiEjuEtdomA+E1iOw==",
                            Gender = "Famela",
                            IsDeleted = false,
                            LastName = "evKlCl7mIBJkEqQf5ueGMg==",
                            PasswordHash = new byte[] { 201, 106, 66, 73, 206, 51, 236, 239, 166, 194, 96, 10, 127, 81, 187, 85, 142, 99, 14, 103, 173, 112, 53, 122, 216, 195, 70, 220, 122, 92, 20, 248, 107, 33, 42, 36, 9, 182, 170, 11, 233, 36, 18, 211, 206, 94, 155, 59, 210, 242, 174, 168, 141, 94, 170, 182, 225, 253, 92, 130, 101, 131, 180, 181 },
                            PasswordSalt = new byte[] { 12, 4, 1, 146, 193, 158, 220, 143, 174, 87, 221, 207, 192, 223, 107, 104, 12, 193, 242, 36, 182, 127, 154, 255, 144, 42, 159, 191, 133, 75, 184, 52, 161, 78, 191, 97, 6, 205, 87, 5, 158, 132, 44, 131, 70, 114, 31, 92, 125, 120, 238, 78, 150, 86, 160, 144, 128, 196, 212, 191, 47, 24, 250, 5, 89, 228, 3, 118, 60, 55, 209, 227, 200, 232, 54, 111, 122, 56, 153, 27, 197, 180, 196, 123, 182, 33, 243, 174, 43, 203, 241, 125, 242, 135, 58, 192, 69, 46, 163, 192, 128, 163, 133, 121, 81, 195, 20, 192, 233, 46, 22, 240, 252, 120, 64, 105, 241, 222, 128, 111, 155, 219, 109, 130, 236, 164, 8, 11 },
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 11, 21, 23, 39, 29, 643, DateTimeKind.Utc).AddTicks(4365),
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 11, 21, 23, 39, 29, 643, DateTimeKind.Utc).AddTicks(4478),
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2024, 11, 21, 23, 39, 29, 643, DateTimeKind.Utc).AddTicks(4599),
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 11, 22, 2, 39, 29, 643, DateTimeKind.Local).AddTicks(6073),
                            OperationClaimId = 1,
                            UserId = 4
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 11, 22, 2, 39, 29, 643, DateTimeKind.Local).AddTicks(6079),
                            OperationClaimId = 2,
                            UserId = 1
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 11, 22, 2, 39, 29, 643, DateTimeKind.Local).AddTicks(6082),
                            OperationClaimId = 3,
                            UserId = 3
                        },
                        new
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2024, 11, 22, 2, 39, 29, 643, DateTimeKind.Local).AddTicks(6085),
                            OperationClaimId = 3,
                            UserId = 2
                        });
                });
